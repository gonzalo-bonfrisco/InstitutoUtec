    ...
    public class AuthService : IAuthService
    {
        ...
        public string GenerateToken(DateTime fechaActual, string username, TimeSpan tiempoValidez)
        {
            ...
            var signingCredentials = new SigningCredentials(
                    new SymmetricSecurityKey(Encoding.ASCII.GetBytes("PepitoFueAlParqueConFirulayEl20220607")),//"G3VF4C6KFV43JH6GKCDFGJH45V36JHGV3H4C6F3GJC63HG45GH6V345GHHJ4623FJL3HCVMO1P23PZ07W8")),
